...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white shadow-sm">
                ...
                <div className="w-1/2 border-r">
                  ...
                  {Object.keys(subjectsByCategory).map((category) => (
                    <div
                      ...
                      className={`cursor-pointer px-3 py-2 capitalize transition ${activeCategory === category
      ...
      <div className="relative w-full md:hidden px-4 py-2">
        <input
          type="text"
          value={query}
          onChange={(e) => setQuery(e.target.value)}
          placeholder="Search quizzes..."
          className="w-full rounded-lg border border-gray-300 bg-gray-50 py-2 pl-4 pr-10 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
        />
        <FontAwesomeIcon
          icon={faSearch}
          className="absolute right-7 top-1/2 -translate-y-1/2 text-gray-400 text-sm"
        />
      </div>
